...
$query = "SELECT * FROM rankedscoresview WHERE category_id = 4";
...
<body>
    <div class="container mt-5">
        <h2 class="text-center mb-4">Best in Formal</h2>
            ...
            <div class="card-body">
                <table class="table table-bordered table-hover">
                    <thead class="tableHead text-center">
                        <tr>
                            <th>Participant Number</th> <!-- Added column for Participant Number -->
                    ...
                    <tbody class="tableBody text-center">
                        <?php if (!empty($femaleResults)): ?>
                            <?php foreach ($femaleResults as $row): ?>
                                <tr>
                                    <td><?= htmlspecialchars($row['participant_num']) ?></td> <!-- Display Participant Number -->
                                    <td><?= htmlspecialchars($row['participant_name']) ?></td>
                                    <td><?= htmlspecialchars($row['avg_total_score']) ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr>
