...
$participants = $pdo->query("SELECT * FROM top_3_participants ORDER BY ranking_within_gender ASC")->fetchAll(PDO::FETCH_ASSOC);
...
foreach ($participants as $participant) {
    if (strtolower($participant['gender']) == 'male') {
        $maleParticipants[] = [
            ...
            'score' => number_format($participant['avg_total_score'], 2),
            'ranking' => number_format($participant['ranking_within_gender'], 2)
        ];
