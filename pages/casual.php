    ...
    <div class="container py-4">
        <form method="post" id="scoringForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="criteria-section mb-3">
                                        <h6 class="mb-3">Best in Casual Attire</h6>
                                        <div class="score-input-group">
                                            <label for="casual">Casual (Max: 15)</label>
                                            <input type="number" class="form-control" id="casual" min="0" max="15"
            ...
            <div id="stepSummary" class="summary-step" style="display: none;">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="mb-3">Best in Casual Attire</h5>
                        <table class="table table-bordered table-hover summary-table">
                            ...
                            <tbody id="summaryCasualTable"></tbody>
                        </table>
                    </div>
...
<script>
    ...
    <?php if (isset($scores_by_participant)): ?>
        <?php foreach ($scores_by_participant as $participantId => $scores): ?>
            existingScores[<?= $participantId ?>] = {
                casual: <?= isset($scores[3]) ? $scores[3] : 'null' ?>,
    ...
    function loadCandidate(index) {
        ...
        document.getElementById('casual').value = savedScores.casual || '';
    ...
    function saveCurrentScores() {
        ...
        scores[participant.id] = {
            casual: document.getElementById('casual').value || null,
    ...
    function populateSummaryTables() {
        const casualTableBody = document.getElementById('summaryCasualTable');
        const prelimTableBody = document.getElementById('summaryPrelimTable');

        casualTableBody.innerHTML = '';
        ...
        participants.forEach(participant => {
            ...
            if (lastGender && lastGender !== participant.gender) {
                ...
                casualTableBody.innerHTML += dividerRow1;
            ...
            const casualRow = `
                ...
                `;
            casualTableBody.innerHTML += casualRow;
