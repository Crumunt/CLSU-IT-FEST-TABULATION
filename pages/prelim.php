                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="tableHead1 text-center">
                            ...
                            <tr>
                                ...
                                <th>Ability to Answer (20)</th>
                                <th>Overall Appeal (10)</th>
                            </tr>
                        </thead>
                        <tbody class="tableBody">
                            <?php
                            $last_gender = ''; // Track the last gender
                            foreach ($participants as $participant):
                                // Add a divider when the gender changes
                                ...
                                // Update the last gender for the next iteration
                                $last_gender = $participant['gender'];
                                ?>
                                <tr class="tableRow">
                                    ...
                                    <td>
                                        <input type="number" class="form-control" name="scores[<?= $participant['participant_id'] ?>][5]" min="1" max="40"
                                            value="<?= isset($scores_by_participant[$participant['participant_id']][5])
                                                        ? $scores_by_participant[$participant['participant_id']][5]
                                                        : '' ?>" step="1" placeholder="0">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="scores[<?= $participant['participant_id'] ?>][6]" min="1" max="30"
                                            value="<?= isset($scores_by_participant[$participant['participant_id']][6])
                                                        ? $scores_by_participant[$participant['participant_id']][6]
                                                        : '' ?>" step="1" placeholder="0">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="scores[<?= $participant['participant_id'] ?>][7]" min="1" max="20"
                                            value="<?= isset($scores_by_participant[$participant['participant_id']][7])
                                                        ? $scores_by_participant[$participant['participant_id']][7]
                                                        : '' ?>" step="1" placeholder="0">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="scores[<?= $participant['participant_id'] ?>][8]" min="1" max="10"
                                            value="<?= isset($scores_by_participant[$participant['participant_id']][8])
                                                        ? $scores_by_participant[$participant['participant_id']][8]
                                                        : '' ?>" step="1" placeholder="0">
                                    </td>
                                </tr>
                            <?php endforeach; ?>
