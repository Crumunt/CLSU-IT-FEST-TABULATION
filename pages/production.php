    ...
    <div class="container py-4">
        <form method="post" id="scoringForm">
            ...
            <div id="stepSummary" class="summary-step" style="display: none;">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="mb-3">Best in Production Attire</h5>
...
<script>
    ...
    function loadCandidate(index) {
        ...
        document.getElementById('production').value = savedScores.production || '';
    ...
    function populateSummaryTables() {
        const productionTableBody = document.getElementById('summaryProductionTable');
        ...
        participants.forEach(participant => {
            ...
            const productionRow = `
                ...
                `;
            productionTableBody.innerHTML += productionRow;
